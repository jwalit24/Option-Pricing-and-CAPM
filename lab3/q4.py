...
def binomial_markov_based(S0, K, T, M, r, sigma, display):
  curr_time = time.time()
  t = T/M
...
def binomail_without_markov(S0, K, T, M, r, sigma, display):
  curr_time = time.time()
...
def main():
  ...
  for m in M1:
    prices1.append(binomail_without_markov(S0 = 100, T = 1, K = 100, M = m, r = 0.08, sigma = 0.20, display = 1))


  print('\n\n######################  Efficient Binomial Algorithm executing (Markov Based)  ######################')
  for m in M2:
    prices2.append(binomial_markov_based(S0 = 100, T = 1, K = 100, M = m, r = 0.08, sigma = 0.20, display = 1))
  ...
  prices1.clear()
  for m in M:
    prices1.append(binomial_markov_based(S0 = 100, T = 1, K = 100, M = m, r = 0.08, sigma = 0.20, display = 0))
  ...
  # sub-part (c)
  print("\n\n-----------------------  sub-part(c)  -----------------------")
  binomial_markov_based(S0 = 100, T = 1, K = 100, M = 5, r = 0.08, sigma = 0.20, display = 2)
